...
public class DirectorRepositoryImpl extends BaseRepository<Director> implements DirectorRepository {
    ...
    private static final String FIND_ALL_QUERY = "SELECT * FROM directors ORDER BY director_id ASC";
    ...
    private static final String EXIST_BY_IDS_QUERY = "SELECT director_id FROM directors WHERE director_id IN (%s)";
    ...
    public Director update(Director director) {
        update(UPDATE_DIRECTOR_QUERY, director.getName(), director.getDirectorId());
        return director;
    }
